 ...
 * '<em><b>Entity Type Reference Multiplicity</b></em>', and utility methods for
 * working with them. <!-- end-user-doc -->
 * 
 * @see de.mkonersmann.ejb31.Ejb31Package#getEntityTypeReferenceMultiplicity()
 * @model
 * @generated
 */
public enum EntityTypeReferenceMultiplicity implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>MANY TO ONE</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>MANY TO MANY</b></em>' literal object. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 ...
	 * <p>
	 * If the meaning of '<em><b>MANY TO ONE</b></em>' literal object isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <p>
	 * If the meaning of '<em><b>MANY TO MANY</b></em>' literal object isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * An array of all the '<em><b>Entity Type Reference Multiplicity</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final EntityTypeReferenceMultiplicity[] VALUES_ARRAY = new EntityTypeReferenceMultiplicity[] {
			ONE_TO_ONE, ONE_TO_MANY, MANY_TO_ONE, MANY_TO_MANY, };

	/**
	 * A public read-only list of all the '<em><b>Entity Type Reference
	 * Multiplicity</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<EntityTypeReferenceMultiplicity> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Entity Type Reference Multiplicity</b></em>' literal
	 ...
	 * @generated
	 */
	public static EntityTypeReferenceMultiplicity get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EntityTypeReferenceMultiplicity result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static EntityTypeReferenceMultiplicity getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EntityTypeReferenceMultiplicity result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static EntityTypeReferenceMultiplicity get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private EntityTypeReferenceMultiplicity(int value, String name, String literal) {
		this.value = value;
		this.name = name;
