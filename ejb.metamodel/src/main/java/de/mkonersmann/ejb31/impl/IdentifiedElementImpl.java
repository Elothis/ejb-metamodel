 ...
 * </p>
 * <ul>
 * <li>{@link de.mkonersmann.ejb31.impl.IdentifiedElementImpl#getId
 * <em>Id</em>}</li>
 * </ul>
 *
 * @generated
...
public class IdentifiedElementImpl extends EObjectImpl implements IdentifiedElement {
	...
	protected EClass eStaticClass() {
		return Ejb31Package.Literals.IDENTIFIED_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ejb31Package.IDENTIFIED_ELEMENT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ejb31Package.IDENTIFIED_ELEMENT__ID:
			return getId();
		}
