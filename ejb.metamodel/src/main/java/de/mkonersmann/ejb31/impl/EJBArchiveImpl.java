 ...
 * </p>
 * <ul>
 * <li>{@link de.mkonersmann.ejb31.impl.EJBArchiveImpl#getRootPackages <em>Root
 * Packages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EJBArchiveImpl extends ArchiveImpl implements EJBArchive {
	/**
	...
	protected EClass eStaticClass() {
		return Ejb31Package.Literals.EJB_ARCHIVE;
	}
	...
	public EList<EJBPackage> getRootPackages() {
		if (rootPackages == null) {
			rootPackages = new EObjectContainmentEList<EJBPackage>(EJBPackage.class, this,
					Ejb31Package.EJB_ARCHIVE__ROOT_PACKAGES);
		}
		return rootPackages;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Ejb31Package.EJB_ARCHIVE__ROOT_PACKAGES:
